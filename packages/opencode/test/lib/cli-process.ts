...
//   - APEX_CONFIG_CONTENT      : provider config inline, no files to find
//   - APEX_TEST_HOME           : pins os.homedir() → tmpdir
//   - APEX_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - APEX_PURE                : skip external plugin discovery + install
//   - APEX_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    APEX_CONFIG_CONTENT: configJson,
    APEX_DISABLE_PROJECT_CONFIG: "1",
    APEX_PURE: "1",
    APEX_DISABLE_AUTOUPDATE: "1",
    APEX_DISABLE_AUTOCOMPACT: "1",
    APEX_DISABLE_MODELS_FETCH: "1",
    APEX_AUTH_CONTENT: "{}",
  }
}
